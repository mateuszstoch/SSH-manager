...
# Configuration
# -------------------------------------------------------------------------
$RepoUrl = "https://github.com/mateuszstoch/SSH-manager"
$InstallDir = "$HOME\.sm"
...
if ($Version -eq "latest") {
    $DownloadUrl = "$RepoUrl/releases/latest/download/sm-$Target.zip"
} else {
    $DownloadUrl = "$RepoUrl/releases/download/$Version/sm-$Target.zip"
}

# -------------------------------------------------------------------------
# Installation Logic
# -------------------------------------------------------------------------
Write-InfoBold "Installing sm ($Version) for $Target..."
...
$ZipPath = "$BinDir\sm_download.zip"
...
# -------------------------------------------------------------------------
Write-Host ""
Write-Success "sm ($Version) was installed successfully to $ExePath"
Write-Host ""
